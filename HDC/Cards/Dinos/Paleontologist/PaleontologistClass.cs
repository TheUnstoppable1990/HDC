...
namespace HDC.Class
{
    ...
    {
        internal static string name = "Paleo";

        public override IEnumerator Init()
        {
            while (!(Paleontologist.card && DigSite.card && Carnivore.card && Herbivore.card && PiercingTeeth.card && RendingClaws.card && ArmorPlates.card && DefensiveSpines.card)) yield return null;
